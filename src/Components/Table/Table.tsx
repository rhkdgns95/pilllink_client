                    ...
                    <RecordTable>
                        ...
                        <Tbody>
                            ...
                            <Tr>
                                ...
                                <Td colSpan={6}>{ confirmId ? confirmId : <LinkBtn to={{pathname: "/feedback", state: { recordId: id}}} >Feedback<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg></LinkBtn> }</Td>
                            </Tr>
                        </Tbody>
                    </RecordTable>
                </Record>
